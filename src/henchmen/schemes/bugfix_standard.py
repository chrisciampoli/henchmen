    ...
    nodes=[
        ...
        SchemeNode(
            ...
            instruction_template=(
                ...
                "WORKFLOW:\n"
                "1. INVESTIGATE: Use grep_search and file_read to find the bug.\n"
                "   - Form a hypothesis quickly. Don't over-read.\n"
                "2. FIX: Make the minimal change using file_edit.\n"
                "   - Do NOT refactor or add features — fix the bug only.\n"
